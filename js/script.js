...
const products = {
  ...
  chaveiros: {
    ...
    items: [
      ...
      { file: "button 4.png", title: "Em Família", badge: "Botton" },
      { file: "button 3.png", title: "Emanuella", badge: "Botton" },
      { file: "button 1.png", title: "Comunhão em Ação", badge: "Botton" },
      { file: "button 2.png", title: "Saúde na Escola", badge: "Botton" },
    ],
  },
};
